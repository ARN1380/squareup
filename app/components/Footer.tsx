  ...
  return (
    <footer className="px-4 py-[30px] border-t border-gray-15 flex justify-center">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between">
        <div className="pb-[30px] flex justify-center items-center border-b border-gray-15 xl:border-0 xl:pb-0 xl:flex-1">
          <Image src={logo} alt="square up logo" width={150} />
        </div>
        <div className="py-[30px] px-4 flex-grow">
        ...
        <div className="border border-gray-15 p-4 flex flex-col justify-center items-center rounded-lg gap-4 xl:flex-row xl:flex-1">
